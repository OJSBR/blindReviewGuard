...
/**
 * @file plugins/generic/blindReviewGuard/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public const PLACEHOLDERS = [
        'plugins.generic.blindReviewGuard.log.findings' => ['{$details}', '{$filename}', '{$total}'],
        'plugins.generic.blindReviewGuard.log.cleaned' => ['{$details}', '{$filename}', '{$removed}'],
        'plugins.generic.blindReviewGuard.notification.findings' => ['{$details}', '{$filename}'],
        'plugins.generic.blindReviewGuard.notification.beforeReviewer' => ['{$details}', '{$filename}'],
    ];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.blindReviewGuard\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
